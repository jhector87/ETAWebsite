...
<h2 style="color:white; background: rgba(0.0,0.0, 0.0, 0.5)">Be as efficient as if it was your second nature.</h2>
	...
	<main>
		...
		<div class="responsive">
			<div class="gallery">
				<a target="_blank" href="../../src/res/images/png/1086695-computer-technology/png/008-data-link.png">
		...
		<div class="responsive">
			<div class="gallery">
				<a target="_blank" href="../../src/res/images/png/1086695-computer-technology/png/030-shield.png">
		...
		<div class="responsive">
			<div class="gallery">
				<a target="_blank" href="../../src/res/images/png/1086695-computer-technology/png/032-network-1.png">
		...
		<div class="quickrequest oval" id="#top">
			<form action="../../src/config/request.php" method="post">
				...
				<p><span class="requestMsg"><input type="text" placeholder="Enter your request here..." name="request"></span></p>
				<br>
