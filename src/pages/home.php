...
<div class="fixed-bckg" id="rectangle top">
    ...
    <div class="logo2" id="logo-animation"><img src="../res/icons/png/002-antenna.png"><br>
        <h2 style="color:white; background: rgba(0.0,0.0, 0.0, 0.5)">Be as efficient as if it was your second
            nature.</h2>
    </div>
</div>
...
<div class="responsive">
    <div class="gallery">
        <a>
            <img src="../res/images/png/005-cloud-server.png" alt="CLOUD SERVER" width="512" height="312">
        </a>
        <div class="desc">
            <h3>Database</h3>
            <p>Maecenas sed diam eget risus varius blandit sit amet non magna. Nullam id dolor idnibh ultricies
                ...
                Vestibulum id ligula porta felis euismod semper. Vivamus sagittis lacus vel augue laoreet rutrum
                faucibus dolor auctor.</p>
            <p>
                Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor
                mauris condimentum nibh, ut fermentum massa justo sit amet risus. Cum sociis natoque penatibus et magnis
                dis parturient montes, nascetur ridiculus mus. Integer posuere erat a ante venenatis dapibus posuere
                velit aliquet. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
                Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Maecenas faucibus mollis
                interdum.</p>

            <p>Curabitur blandit tempus porttitor. Praesent commodo cursus magna, vel scelerisque nisl consectetur
                et. Vestibulum id ligula porta felis euismod semper. Lorem ipsum dolor sit amet, consectetur adipiscing
                elit. Donec sed odio dui.</p>

            <p>Vestibulum id ligula porta felis euismod semper. Duis mollis, est non commodo luctus, nisi erat
...
<div class="responsive">
    <div class="gallery">
        <a>
            <img src="../res/images/png/030-shield.png" alt="SECURITY" width="512" height="312">
        </a>
        <div class="desc">
            <h3>Security</h3>
            <p>Best-in-class 256-bit AES encryption
                Your data is protected by advanced mathematics in AES-256, the encryption standard trusted by
                security experts worldwide.</p>

            <p>IP address masking:
                No need to reveal your true IP address and location; change your IP address through one of
                ExpressVPN's secure VPN servers.
            </p>
...
<div class="responsive">
    <div class="gallery">
        ...
        <a>
            <img src="../res/images/png/032-network-1.png" alt="Network" width="512" height="312">
        </a>
    </div>
</div>
